...
#target_lat, target_lon, target_alt = 0
...
def start_mission(target_lat, target_lon, target_alt):
    #waypoint_lat = 34.4039209  # Replace with your target latitude
    #waypoint_lon = -119.6968659   # Replace with your target longitude
    #waypoint_alt = 8.04        # Altitude in meters (relative to home)
    ...
    wp_current = 0
    wp_autocontinue = 1
    wp_param = [0, 0, 0, 0, target_lat, target_lon, target_alt]
    ...
    TARGET_RADIUS = 5.0  # 5 meter acceptance radius
...
if __name__ == "__main__":
    ...
    target_lat, target_lon, target_alt = get_gps_data()
    #print("Lat: " + str(home_lat) + ",Lon: " + str(home_lon) + ", Alt: " + str(home_alt))
 
    print("MAIN LOG: STARTING MISSION")
    start_mission(target_lat, target_lon, target_alt)
