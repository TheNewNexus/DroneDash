...
def start_mission(home_waypoint_lat, home_waypoint_lon, home_waypoint_alt):
...
if __name__ == "__main__":
    ...
    start_mission(home_lat, home_lon, home_alt)
    ...
    print("MAIN LOG: STARTING DRIVE")
    send_forward_velocity(velocity=1.0, duration=3.0)
    print("MAIN LOG: STOP") """
